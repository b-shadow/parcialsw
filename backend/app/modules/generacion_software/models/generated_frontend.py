...
class GeneratedFrontend(UuidPrimaryKeyMixin, TimestampMixin, Base):
    __tablename__ = "generated_frontends"
    ...
    backend_id: Mapped[UUID | None] = mapped_column(
        PG_UUID(as_uuid=True), ForeignKey("generated_backends.id")
    )
    name: Mapped[str] = mapped_column(String(160), nullable=False)
    technology: Mapped[str] = mapped_column(String(80), nullable=False, default="Flutter")
    language: Mapped[str] = mapped_column(String(40), nullable=False, default="Dart")
